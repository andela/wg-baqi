...
def create_demo_entries(user):
    ...
    setting_list.append(Setting(
        set=day_set, exercise=exercise, reps=10, order=1))
    ...
    setting_list.append(Setting(
        set=day_set, exercise=exercise, reps=30, order=1))
    setting_list.append(Setting(
        set=day_set, exercise=exercise, reps=99, order=2))
    setting_list.append(Setting(
        set=day_set, exercise=exercise, reps=35, order=3))
    ...
    setting_list.append(Setting(
        set=day_set, exercise=exercise, reps=30, order=1))
    setting_list.append(Setting(
        set=day_set, exercise=exercise, reps=40, order=2))
    setting_list.append(Setting(
        set=day_set, exercise=exercise, reps=99, order=3))
