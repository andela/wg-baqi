    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protein',
                 models.DecimalField(
                     decimal_places=3, help_text='In g per 100g of product',
                     max_digits=6, validators=[
                ...
                ('fat_saturated',
                 models.DecimalField(
                     blank=True,
                     decimal_places=3,
                     help_text='In g per 100g of product', max_digits=6,
                     null=True,
                     validators=[
                         django.core.validators.MinValueValidator(0),
                         django.core.validators.MaxValueValidator(100)],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(
                    ...
                    max_digits=5, verbose_name='Amount')),
                ('ingredient', models.ForeignKey(
                    editable=False,
                    on_delete=django.db.models.deletion.CASCADE,
                    to='nutrition.Ingredient', verbose_name='Ingredient')),
            ],
        ),
        migrations.CreateModel(
            name='Meal',
            fields=[
                ...
                ('time', wger.utils.fields.Html5TimeField(
                    blank=True, null=True, verbose_name='Time (approx)')),
            ],
            options={
                'ordering': ['time'],
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to='nutrition.WeightUnit', verbose_name='Weight unit'),
        ),
    ]
