...
def next_weekday(date, weekday):
    ...
    * http://stackoverflow.com/questions/6558535/
    python-find-the-date-for-the-first-monday-after-a
...
def smart_capitalize(input):
    ...
    python's
    capitalize and the similar django template tag mainly because of side
    effects
    when applied to all caps words. E.g. the German "KH" (Kurzhantel) is
    capitalized
    to "Kh" or "ß" to "SS". Because of this, only words with more than 2
    letters as
