...
@task(help={
    ...
    'port': 'Port to use. Default: 8000',
            ...
            'extra-args': 'Additional arguments to pass to the builtin \
...
def bootstrap_wger(context,
    ...
    if start_server:
        ...
        start_wger(
            ...
            browser=browser, settings_path=settings_path)
...
def create_settings(
        context, settings_path=None,
        database_path=None, url=None, database_type='sqlite3', key_length=50):
    '''
