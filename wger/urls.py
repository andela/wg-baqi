...
router.register(
    r'workout',
    manager_api_views.WorkoutViewSet, base_name='workout')
router.register(
    r'workoutsession',
...
router.register(
    r'exercisecategory', exercises_api_views.ExerciseCategoryViewSet,
...
router.register(
    r'nutritionplan', nutrition_api_views.NutritionPlanViewSet,
