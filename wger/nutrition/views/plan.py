    ...
    * http://www.reportlab.com/apis/reportlab/dev/platypus.html
    ...
    for meal in plan.meal_set.select_related():
        ...
        for item in meal.mealitem_set.select_related():
            ...
            p = Paragraph(u'<para>{0}</para>'.format(
                item.ingredient.name), styleSheet["Normal"])
            ...
            data.append([Paragraph(u"{0}{1}".format(
                item.amount, unit_name), styleSheet["Normal"]),
                p])
    ...
    for marker in meal_markers:
        ...
        table_style.append(('BACKGROUND', (0, marker),
                            (-1, marker), header_colour))
        table_style.append(('BOX', (0, marker),
                            (-1, marker), 1.25, colors.black))
    ...
    data.append([Paragraph(_('Carbohydrates'), styleSheet["Normal"]),
        ...
        Paragraph(six.text_type(plan_data['per_kg']['carbohydrates']),
                  styleSheet["Normal"])])
    data.append([Paragraph(_(
        'Sugar content in carbohydrates'), styleSheet["Normal"]),
        Paragraph(six.text_type(plan_data['total']['carbohydrates_sugar']),
                  styleSheet["Normal"])])
    data.append([Paragraph(_('Fat'),
                           styleSheet["Normal"]),
