...
class ApiCommandsTest(WorkoutManagerTestCase):
    ...
    def test_user_allow_register_via_rest_api(self):
        ...
        call_command('add-user-rest-api', 'test_user', stdout=out)
        self.assertIn('', out.getvalue())

    def test_all_list_users_created(self):
        ...
        out = StringIO()
        call_command('list-user-rest-api', 'test_user', stdout=out)
        self.assertIn('', out.getvalue())
