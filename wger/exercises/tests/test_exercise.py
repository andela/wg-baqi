...
class ExerciseIndexTestCase(WorkoutManagerTestCase):
    ...
    def test_exercise_index_non_editor(self):
        '''
        Tests the exercise overview page as a logged in user without editor
        rights
        '''
...
class ExerciseDetailTestCase(WorkoutManagerTestCase):
    ...
    def exercise_detail(self, editor=False):
        ...
        response = self.client.get(reverse(
            'exercise:exercise:view', kwargs={'id': 1}))
        self.assertEqual(response.status_code, 200)
        ...
        response = self.client.get(reverse(
            'exercise:exercise:view', kwargs={'id': 42}))
...
class ExercisesTestCase(WorkoutManagerTestCase):
    ...
    def add_exercise_success(self, admin=True):
        ...
        self.assertEqual(count_before + 1,
                         count_after, 'Exercise was not added')
        ...
        response = self.client.get(reverse(
            'exercise:exercise:view', kwargs={'id': exercise_id}))
        self.assertEqual(response.status_code, 200)
        ...
        response = self.client.post(reverse(
            'exercise:exercise:edit', kwargs={'pk': '1'}),
            {'category': 111,
             'name_original': 'my test exercise',
             'license': 1,
             'language': 1,
...
class ExercisesCacheTestCase(WorkoutManagerTestCase):
    ...
    def test_overview_cache_update(self):
        ...
        old_muscle_overview = cache.get(get_template_cache_name(
            'muscle-overview', 2))
