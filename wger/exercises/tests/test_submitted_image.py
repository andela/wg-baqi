...
class ImagePendingDetailTestCase(WorkoutManagerTestCase):
    ...
    def test_pending_view_admin(self):
        '''
        Tests the detail page of an exercise with a pending image as an admin
        user
        '''
    ...
    def test_pending_view_user(self):
        '''
        Tests the detail page of an exercise with a pending image as a regular
        user
        '''
    ...
    def test_pending_view_logged_out(self):
        '''
        Tests the detail page of an exercise with a pending image as a logged
        out user
        '''
