# Generated by Django 2.2.1 on 2019-05-28 12:19
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gym', models.OneToOneField(
                    editable=False,
                    on_delete=django.db.models.deletion.CASCADE,
                    related_name='config', to='gym.Gym')),
            ],
        ),
        migrations.CreateModel(
            name='ContractType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(
                    decimal_places=2,
                    default=0, max_digits=12, verbose_name='Amount')),
                ('payment',
                 models.CharField(choices=[
                     ...
                     ('3', 'Monthly'), ('4', 'Biweekly'), ('5', 'Weekly'), (
                         '6', 'Daily')],
                     default='3',
                     help_text='How often the amount will be charged to the \
                     member',
                     max_length=2, verbose_name='Payment type')),
                ('is_active', models.BooleanField(
                    default=True, verbose_name='Contract is active')),
                ...
                ('contract_type',
                 models.ForeignKey(
                     ...
                     on_delete=django.db.models.deletion.CASCADE,
                     to='gym.ContractType', verbose_name='Contract type')),
                ('member',
                 models.ForeignKey(
                     editable=False,
                     on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('include_inactive',
                 models.BooleanField(
                     default=True,
                     help_text='Include this user in the email list with \
                     inactive members', verbose_name='Include in inactive \
                     overview')),
                ('gym',
                 models.ForeignKey(
                     editable=False,
