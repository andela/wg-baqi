...
class WorkoutCanonicalFormTestCase(WorkoutManagerTestCase):
    ...
    def test_canonical_form(self):
        ...
        self.assertEqual(workout.canonical_representation['obj'],
                         workout)
        ...
        canonical_form = {
            ...
            'set_list': [{
                'exercise_list': [{
                    ...
                    'setting_list': [u'10 (15 kg)', u'10 (15 kg)',
                                     u'10 (15 kg)', u'10 (15 kg)'],
    ...
    def test_canonical_form_day(self):
        ...
        weekday1 = DaysOfWeek.objects.get(pk=3)  # noqa
        weekday2 = DaysOfWeek.objects.get(pk=5)  # noqa
        repetition_unit = RepetitionUnit.objects.get(pk=1)
        weight_unit = WeightUnit.objects.get(pk=1)
        ...
        canonical_form = [{
            'exercise_list': [{
                ...
                'repetition_units': [repetition_unit, repetition_unit,
                                     repetition_unit, repetition_unit],
                'weight_units': [weight_unit, weight_unit, weight_unit,
                                 weight_unit],
            }],
            'is_superset': False,
            'has_settings': True,
